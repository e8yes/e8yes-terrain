...
PipelineKey PostProcessorPipeline2::Key() const { return pimpl_->key; }

Fulfillment PostProcessorPipeline2::Launch(CachedPipelineArgumentsInterface const &generic_args,
